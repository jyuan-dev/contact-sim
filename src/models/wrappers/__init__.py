...
Available wrappers (registered names):
  - "detr"             → StandardizedDETRWrapper
  - "deformable_detr"  → StandardizedDeformableDETRWrapper
  - "savi", "stosavi"  → StandardizedSAViWrapper
  - "deformable_savi"  → StandardizedDeformableSAViWrapper
"""

from src.models.wrappers.detr_wrapper import StandardizedDETRWrapper
from src.models.wrappers.deformable_detr_wrapper import StandardizedDeformableDETRWrapper
