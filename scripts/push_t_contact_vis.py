"""
Extract and visualize normal and frictional forces on PushT episode 0 from simulator.
"""
import os
...
REPO_ROOT  = os.path.dirname(SCRIPT_DIR)  # assumes placed in contact-sim/scripts/
